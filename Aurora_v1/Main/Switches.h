...
//creating type "State"
enum State {HOME = 0, LESSONS = 1, LEARN = 2, PLAY = 3, SETTINGS = 4, SHIFTING = 5, SUSTAIN = 6, CHORDS = 7, PLAYING_LESSON = 8, LEARNING_SONG = 9, PLAYING_SONG = 10, FINISHED_LESSON = 11, FINISHED_LEARNING = 12, FINISHED_PLAYING = 13, PAUSED = 14, CHOOSE_BPM = 15, REC_RED = 16, REC_BLUE = 17, REC_GREEN = 18, REC_PURPLE = 19, REC_OPEN = 20, REC_TEMPO = 21, REC_NEXT = 22};
